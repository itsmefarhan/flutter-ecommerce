...
import 'package:shopping_arena/screens/add_edit_product.dart';
...
import 'package:shopping_arena/screens/user_products.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/addOrEditProduct': (context) => AddOrEditProductScreen()
        },
      ),
    );
  }
